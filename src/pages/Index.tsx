...
const Index = () => {
  return (
    <>
      ...
      <div className="w-full grid grid-cols-3 gap-4 sm:gap-8 py-8 bg-transparent place-items-center">
        <img
        ...
        />
        <img
          src="https://thumbs.dreamstime.com/b/licensed-bonded-insured-vector-icon-business-86546455.jpg"
          alt="Licensed Bonded Insured Badge 3"
          className="h-16 sm:h-32 w-auto object-contain"
        />
      </div>
      <Footer />
